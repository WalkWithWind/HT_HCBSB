...
dsy.add("0_0", ["北京市"]);
dsy.add("0_1_0", ["和平区", "河东区", "河西区", "南开区", "河北区", "红桥区", "塘沽区", "汉沽区", "大港区", "东丽区", "西青区", "津南区", "北辰区", "武清区", "宝坻区", "蓟县", "宁河县", "芦台镇", "静海县"]);
dsy.add("0_1", ["天津市"]);
dsy.add("0_2_0", ["黄浦区", "卢湾区", "徐汇区", "长宁区", "静安区", "普陀区", "闸北区", "虹口区", "杨浦区", "闵行区", "宝山区", "嘉定区", "浦东新区", "金山区", "松江区", "青浦区", "南汇区", "奉贤区", "崇明县", "城桥镇"]);
dsy.add("0_2", ["上海市"]);
dsy.add("0_3_0", ["渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "万盛区", "双桥区", "渝北区", "巴南区", "万州区", "涪陵区", "黔江区", "长寿区", "合川市", "永川区市", "江津市", "南川市", "綦江县", "潼南县", "铜梁县", "大足县", "荣昌县", "璧山县", "垫江县", "武隆县", "丰都县", "城口县", "梁平县", "开县", "巫溪县", "巫山县", "奉节县", "云阳县", "忠县", "石柱自治县", "彭水自治县", "酉阳自治县", "秀山自治县"]);
dsy.add("0_3", ["重庆市"]);
dsy.add("0_4_0", ["长安区", "桥东区", "桥西区", "新华区", "裕华区", "井陉矿区", "辛集市", "藁城市", "晋州市", "新乐市", "鹿泉市", "井陉县", "微水镇", "正定县", "栾城县", "行唐县", "龙州镇", "灵寿县", "高邑县", "深泽县", "赞皇县", "无极县", "平山县", "元氏县", "槐阳镇", "赵县", "赵州镇"]);
dsy.add("0_4_1", ["桥西区", "桥东区", "宣化区", "下花园区", "张北县", "康保县", "沽源县", "平定堡镇", "尚义县", "南壕堑镇", "蔚县", "蔚州镇", "阳原县", "西城镇", "怀安县", "柴沟堡镇", "万全县", "孔家庄镇", "怀来县", "沙城镇", "涿鹿县", "赤城县", "崇礼县", "西湾子镇"]);
dsy.add("0_4_2", ["双桥区", "双滦区", "鹰手营子矿区", "承德县", "下板城镇", "兴隆县", "平泉县", "滦平县", "隆化县", "丰宁自治县", "大阁镇", "宽城自治县", "围场自治县"]);
dsy.add("0_4_3", ["海港区", "山海关区", "北戴河区", "昌黎县", "抚宁县", "卢龙县", "青龙自治县"]);
dsy.add("0_4_4", ["路北区", "路南区", "古冶区", "开平区", "丰润区", "丰南区", "遵化市", "迁安市", "滦县", "滦州镇", "滦南县", "倴城镇", "乐亭县", "乐亭镇", "迁西县", "兴城镇", "玉田县", "唐海县"]);
dsy.add("0_4_5", ["安次区", "广阳区", "霸州市", "三河市", "固安县", "永清县", "香河县", "淑阳镇", "大城县", "平舒镇", "文安县", "大厂自治县"]);
dsy.add("0_4_6", ["新市区", "北市区", "南市区", "定州市", "涿州市", "安国市", "高碑店市", "满城县", "清苑县", "易县", "易州镇", "徐水县", "安肃镇", "涞源县", "定兴县", "顺平县", "蒲阳镇", "唐县", "仁厚镇", "望都县", "涞水县", "高阳县", "安新县", "雄县", "雄州镇", "容城县", "曲阳县", "恒州镇", "阜平县", "博野县", "博陵镇", "蠡县", "蠡吾镇"]);
dsy.add("0_4_7", ["桃城区", "冀州市", "深州市", "枣强县", "枣强镇", "武邑县", "武强县", "饶阳县", "安平县", "故城县", "郑口镇", "景县", "景州镇", "阜城县"]);
dsy.add("0_4_8", ["运河区", "新华区", "泊头市", "任丘市", "黄骅市", "河间市", "沧县", "青县", "清州镇", "东光县", "海兴县", "苏基镇", "盐山县", "肃宁县", "南皮县", "吴桥县", "桑园镇", "献县", "乐寿镇", "孟村自治县"]);
dsy.add("0_4_9", ["桥东区", "桥西区", "南宫市", "沙河市", "邢台县", "临城县", "内丘县", "柏乡县", "隆尧县", "任县", "南和县", "和阳镇", "宁晋县", "凤凰镇", "巨鹿县", "新河县", "广宗县", "平乡县", "丰州镇", "威县", "洺州镇", "清河县", "葛仙庄镇", "临西县"]);
dsy.add("0_4_10", ["丛台区", "邯山区", "复兴区", "峰峰矿区", "武安市", "邯郸县", "临漳县", "成安县", "大名县", "涉县", "涉城镇", "磁县", "磁州镇", "肥乡县", "永年县", "临洺关镇", "邱县", "新马头镇", "鸡泽县", "广平县", "馆陶县", "魏县", "魏城镇", "曲周县"]);
...
dsy.add("0_17", ["武汉市", "十堰市", "襄樊市", "荆门市", "孝感市", "黄冈市", "鄂州市", "黄石市", "咸宁市", "荆州市", "宜昌市", "随州市", "湖北直辖县", "恩施州"]);
...
dsy.add("0_30_4", ["阿克苏市", "温宿县", "温宿镇", "库车县", "库车镇", "沙雅县", "新和县", "拜城县", "乌什县", "乌什镇", "阿瓦提县", "阿瓦提镇", "柯坪县", "柯坪镇"]);
dsy.add("0_30_5", ["和田市", "和田县", "墨玉县", "喀拉喀什镇", "皮山县", "固玛镇", "洛浦县", "策勒县", "于田县", "木尕拉镇", "民丰县", "尼雅镇"]);
...
dsy.add("0_30_10", ["昌吉市", "阜康市", "米泉市", "呼图壁县", "呼图壁镇", "玛纳斯县", "奇台县", "吉木萨尔县", "木垒哈萨克自治县"]);
dsy.add("0_30_11", ["库尔勒市", "轮台县", "轮台镇", "尉犁县", "尉犁镇", "若羌县", "若羌镇", "且末县", "和静县", "和硕县", "特吾里克镇", "博湖县", "焉耆自治县"]);
dsy.add("0_30_12", ["伊宁市", "奎屯市", "伊宁县", "吉里于孜镇", "霍城县", "水定镇", "巩留县", "新源县", "昭苏县", "昭苏镇", "特克斯县", "尼勒克县", "察布查尔锡伯自治县", "察布查尔镇"]);
dsy.add("0_30_13", ["塔城市", "乌苏市", "额敏县", "沙湾县", "三道河子镇", "托里县", "托里镇", "裕民县", "哈拉布拉镇", "和布克赛尔蒙古自治县", "和布克赛尔镇"]);
dsy.add("0_30_14", ["阿勒泰市", "布尔津县", "富蕴县", "库额尔齐斯镇", "福海县", "哈巴河县", "青河县", "吉木乃县"]);
dsy.add("0_30", ["乌鲁木齐市", "克拉玛依市", "新疆直辖县", "喀什地区", "阿克苏地区", "和田地区", "吐鲁番地区", "哈密地区", "克孜勒苏柯州", "博尔塔拉州", "昌吉州", "巴音郭楞州", "伊犁州", "塔城地区", "阿勒泰地区"]);
dsy.add("0_31_0", ["中西区", "东区", "九龙城区", "观塘区", "南区", "深水埗区北京市", "湾仔区", "黄大仙区", "油尖旺区", "离岛区", "葵青区", "北区", "西贡区", "沙田区", "屯门区", "大埔区", "荃湾区", "元朗区"]);
dsy.add("0_31", ["香港"]);
dsy.add("0_32_0", ["澳门"]);
dsy.add("0_32", ["澳门"]);
dsy.add("0_33_0", [" "]);
