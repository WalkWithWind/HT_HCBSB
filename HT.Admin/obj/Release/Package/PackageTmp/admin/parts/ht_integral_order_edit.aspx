<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_integral_order_edit.aspx.cs" Inherits="HT.Admin.admin.parts.ht_integral_order_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>花费积分</dt>
                <dd>
                    <asp:TextBox ID="spend_integral" runat="server" CssClass="input normal" ReadOnly="true"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>收件人姓名</dt>
                <dd>
                    <asp:TextBox ID="acceptname" runat="server" CssClass="input normal" ReadOnly="true"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>联系电话</dt>
            ...
            <dl>
                <dt>省/市/区</dt>
                <dd>
                    <asp:TextBox ID="ssq" runat="server" CssClass="input normal" ReadOnly="true"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>详细地址</dt>
            ...
            <dl>
                <dt>订单审核发货时间</dt>
                <dd>
                    <asp:TextBox ID="audittime" runat="server" CssClass="input normal" ReadOnly="true"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>订单添加时间</dt>
