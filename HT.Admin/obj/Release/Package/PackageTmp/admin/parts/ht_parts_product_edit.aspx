<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_parts_product_edit.aspx.cs" Inherits="HT.Admin.admin.parts.ht_parts_product_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>配件商品类型</dt>
                <dd>
                    <asp:DropDownList ID="ddltype" runat="server" CssClass="input normal">
                    </asp:DropDownList>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>价格</dt>
                <dd>
                    <asp:TextBox ID="price" runat="server" CssClass="input normal" sucmsg=" " datatype="/^[0-9]+(\.[0-9]{1,2})?$/"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>联系人</dt>
                <dd>
                    <asp:TextBox ID="contacts" runat="server" CssClass="input normal" sucmsg=" " datatype="*"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>电话</dt>
                <dd>
                    <asp:TextBox ID="mobile" runat="server" CssClass="input normal" sucmsg=" " datatype="*"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>品牌</dt>
