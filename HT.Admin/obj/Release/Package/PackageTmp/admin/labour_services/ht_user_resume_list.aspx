<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_user_resume_list.aspx.cs" Inherits="HT.Admin.admin.labour_services.ht_user_resume_list" %>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="box-wrap">
                    <div class="l-list">
                        <ul class="icon-list">
                            <%--<li><a class="add" href="ht_user_resume_edit.aspx?action=<%=HTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>--%>
                    ...
                    <div class="r-list">
                        <asp:TextBox ID="txtKeywords" runat="server" CssClass="keyword" placeholder="标题/姓名" />
        ...
        <asp:Repeater ID="rptList" runat="server">
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        ...
                        <th align="center" width="10%">求职岗位</th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><%#new HT.Admin.Models.XHelp().get_ht_user_resume_classify_classid(Eval("classid"))%></td>
                    <td align="center"><%#Eval("name")%></td>
                    <td align="center"><%#Eval("sex").ToString()=="1"?"男":"女"%></td>
                    <td align="center"><%#Eval("age")%></td>
                    <td align="center"><%#Eval("mobile")%></td>
                    <td align="center"><%#new HT.Admin.Models.XHelp().get_ht_user_resume_status(Eval("status"))%></td>
                    <td align="center"><%#Eval("addtime")%></td>
                    <td align="center"><%#new HT.Admin.Models.XHelp().get_ht_user_model(Eval("userid"),"name")%></td>
                    <td align="center"><a href="ht_user_resume_edit.aspx?action=<%#HTEnums.ActionEnum.Edit%>&id=<%#Eval("id")%>">修改</a></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
