<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_freight_shipment_list.aspx.cs" Inherits="HT.Admin.admin.carrier.ht_freight_shipment_list" %>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="box-wrap">
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="ht_freight_shipment_edit.aspx?action=<%=HTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
        ...
        <asp:Repeater ID="rptList" runat="server">
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        ...
                        <th align="center" width="20%">装运要求标题</th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><a href="ht_freight_shipment_edit.aspx?action=<%#HTEnums.ActionEnum.Edit%>&id=<%#Eval("id")%>">修改</a></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
