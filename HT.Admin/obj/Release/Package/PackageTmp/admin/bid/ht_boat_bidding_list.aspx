<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_boat_bidding_list.aspx.cs" Inherits="HT.Admin.admin.bid.ht_boat_bidding_list" %>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="box-wrap">
                    <div class="l-list">
                        <ul class="icon-list">
                            <%--<li><a class="add" href="ht_boat_bidding_edit.aspx?action=<%=HTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>--%>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><a href="../carrier/ht_freight_demand_edit.aspx?action=Edit&id=<%#Eval("bid")%>">查看详情</a></td>
                    <td align="center"><a href="../carrier/ht_transport_demand_edit.aspx?action=Edit&id=<%#Eval("pid")%>">查看详情</a></td>
