            ...
            uploader.on('uploadSuccess', function (file, data) {
                ...
                if (data.status == '1') {
                    ...
                    if (!p.multiple) {
                        ...
                        parentObj.siblings(".upload-images").val(data.size);
                        parentObj.parent().find(".upload-images").attr("src", data.thumb);//扩展
                        parentObj.parent().find(".upload-images").val(data.thumb);//扩展
                    } else {
