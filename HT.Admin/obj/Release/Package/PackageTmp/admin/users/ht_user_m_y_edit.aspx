<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_user_m_y_edit.aspx.cs" Inherits="HT.Admin.admin.users.ht_user_m_y_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>门店名称</dt>
                <dd>
                    <asp:TextBox ID="shopname" runat="server" CssClass="input normal" sucmsg=" " ReadOnly="true"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>手机号</dt>
            ...
            <dl>
                <dt>地址</dt>
                <dd>
                    <asp:TextBox ID="shopaddress" runat="server" CssClass="input normal" sucmsg=" " ReadOnly="true" TextMode="MultiLine"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>门店介绍</dt>
                <dd>
                    <asp:TextBox ID="shopinfo" runat="server" CssClass="input normal" sucmsg=" " ReadOnly="true" TextMode="MultiLine"></asp:TextBox>
                </dd>
            </dl>
        </div>
