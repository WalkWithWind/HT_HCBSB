<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_user_q_h_list.aspx.cs" Inherits="HT.Admin.admin.users.ht_user_q_h_list" %>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="box-wrap">
                    <div class="l-list">
                        <ul class="icon-list">
                            <%--<li><a class="add" href="ht_user_q_h_edit.aspx?action=<%=HTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>--%>
                    ...
                    <div class="r-list">
                        <asp:TextBox ID="txtKeywords" runat="server" CssClass="keyword" placeholder="手机号/法人姓名/公司名称" />
        ...
        <asp:Repeater ID="rptList" runat="server">
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        ...
                        <th align="center" width="10%">QQ</th>
                        <th align="center" width="10%">邮箱</th>
                        <th align="center" width="10%">法人姓名</th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><%#Eval("company")%></td>
                    ...
                    <td align="center"><a href="ht_user_q_h_edit.aspx?action=<%#HTEnums.ActionEnum.Edit%>&id=<%#Eval("id")%>">修改</a></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
