<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_user_q_c_edit.aspx.cs" Inherits="HT.Admin.admin.users.ht_user_q_c_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>公司名称</dt>
                <dd>
                    <asp:TextBox ID="company" runat="server" CssClass="input normal" sucmsg=" " ReadOnly="true"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>手机号</dt>
            ...
            <dl>
                <dt>公司介绍</dt>
                <dd>
                    <asp:TextBox ID="company_introduction" runat="server" CssClass="input normal" sucmsg=" " ReadOnly="true" TextMode="MultiLine"></asp:TextBox>
                </dd>
            </dl>
        </div>
        ...
        <div class="tab-content" style="display: none">
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-multi-radio">
                        <asp:RadioButtonList runat="server" ID="reputation" RepeatDirection="Horizontal">
                            <asp:ListItem Value="0">0星</asp:ListItem>
            ...
            <dl>
                <dt>公司营业执照号</dt>
                <dd>
                    <asp:TextBox ID="charterno" runat="server" CssClass="input normal" ReadOnly="true"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>法人姓名</dt>
            ...
            <dl>
                <dt>营业执照</dt>
                <dd>
                    <a id="charter_img" href="javascript:;" target="_blank" runat="server">查看</a>
                </dd>
            </dl>
            <dl>
                <dt>身份证正面</dt>
            ...
            <dl>
                <dt>运输资格证</dt>
                <dd>
                    <a id="transport_certificate_img" href="javascript:;" target="_blank" runat="server">查看</a>
                </dd>
            </dl>
        </div>
        <!--/内容-->
