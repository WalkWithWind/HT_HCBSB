<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_boat_transport_classify_list.aspx.cs" Inherits="HT.Admin.admin.boat.ht_boat_transport_classify_list" %>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="box-wrap">
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="ht_boat_transport_classify_edit.aspx?action=<%=HTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
                        ...
                        <div class="menu-list ">
                            <div class="rule-single-select">
                                <asp:DropDownList ID="ddlstatus" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlstatus_SelectedIndexChanged">
                                    ...
                                    <asp:ListItem Text="已禁用" Value ="2"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
        ...
        <asp:Repeater ID="rptList" runat="server">
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        ...
                        <th align="center" width="20%">船运类型标题</th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><%#Eval("status").ToString()=="1"?"已启用":"已禁用"%></td>
                    <td align="center"><%#Eval("addtime")%></td>
                    <td align="center"><a href="ht_boat_transport_classify_edit.aspx?action=<%#HTEnums.ActionEnum.Edit%>&id=<%#Eval("id")%>">修改</a></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
