<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_quay_list.aspx.cs" Inherits="HT.Admin.admin.boat.ht_quay_list" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <div class="location">
            ...
            <i class="arrow"></i>
            <span><a href="ht_harbor_list.aspx">港口列表</a></span>
            <i class="arrow"></i>
            <span>码头列表</span>
        </div>
        <!--/导航栏-->
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="box-wrap">
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="ht_quay_edit.aspx?action=<%=HTEnums.ActionEnum.Add %>&gk_id=<%=gk_id %>"><i></i><span>新增</span></a></li>
        ...
        <asp:Repeater ID="rptList" runat="server">
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        ...
                        <th align="center" width="20%">码头标题</th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><a href="ht_quay_edit.aspx?action=<%#HTEnums.ActionEnum.Edit%>&id=<%#Eval("id")%>&gk_id=<%=gk_id %>">修改</a></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
