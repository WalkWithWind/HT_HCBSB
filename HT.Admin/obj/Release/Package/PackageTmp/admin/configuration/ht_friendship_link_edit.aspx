<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ht_friendship_link_edit.aspx.cs" Inherits="HT.Admin.admin.configuration.ht_friendship_link_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>链接</dt>
                <dd>
                    <asp:TextBox ID="link_url" runat="server" CssClass="input normal" sucmsg=" " datatype="*" TextMode="MultiLine"></asp:TextBox>
                </dd>
            </dl>
            <dl>
                <dt>排序</dt>
