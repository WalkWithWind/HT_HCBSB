<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sms_template_edit.aspx.cs" Inherits="HT.Admin.admin.configuration.sms_template_edit" %>
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">短信模版</a></li>
                    </ul>
                </div>
            </div>
        </div>
