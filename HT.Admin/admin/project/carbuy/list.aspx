<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="HT.Admin.admin.project.carbuy.list" %>
    ...
    <div class="maindiv" v-bind:class="['show']">
				...
				<div class="box-wrap">
					...
					<div class="l-list">
						...
						<ul class="icon-list">
                            ...
                            <% if (ChkAdminLevelBool("carbuy_list", HT.Utility.HTEnums.ActionEnum.Delete.ToString()))
                                { %>
							<li><a class="del" v-on:click="del()" ><i></i><span>删除</span></a></li>
                            <%} %>
                            <% if (ChkAdminLevelBool("carbuy_list", HT.Utility.HTEnums.ActionEnum.Audit.ToString()))
                                { %>
                        ...
                        <div class="menu-list">
							...
							<input id="txtFromDate" class="input-date" onclick="WdatePicker()" @keyup.enter="search"/><span class="float-right">&nbsp;至&nbsp;</span><input id="txtToDate" class="input-date" onclick="WdatePicker()" @keyup.enter="search" />
                        </div>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
			...
			<tr v-for="item in dataList">
				...
				<td align="center">{{item.use_type}}</td>
				<td align="center">
