				...
				<div class="box-wrap">
					...
					<div class="l-list">
						...
						<ul class="icon-list">
                            ...
                            <% if (ChkAdminLevelBool("carsale_list", HT.Utility.HTEnums.ActionEnum.Delete.ToString()))
                                { %>
							<li><a class="del" v-on:click="del()" ><i></i><span>删除</span></a></li>
                            <%} %>
                            <% if (ChkAdminLevelBool("carsale_list", HT.Utility.HTEnums.ActionEnum.Audit.ToString()))
                                { %>
