    ...
    <div class="maindiv" v-bind:class="['show']">
				...
				<div class="box-wrap">
					<div class="l-list">
						...
						<ul class="icon-list">
                            ...
                            <% if (ChkAdminLevelBool("goods_list", HT.Utility.HTEnums.ActionEnum.Delete.ToString()))
                                { %>
							<li><a class="del" v-on:click="del()" ><i></i><span>删除</span></a></li>
                            <%} %>
                            <% if (ChkAdminLevelBool("goods_list", HT.Utility.HTEnums.ActionEnum.Audit.ToString()))
                                { %>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
			...
			<tr>
				...
				<th align="center" width="6%">联系人</th>
